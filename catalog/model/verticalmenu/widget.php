...
class ModelVerticalmenuWidget extends Model {		
	...
	protected function getLayout( $layout ){
		if (file_exists(DIR_TEMPLATE . $this->config->get('theme_default_directory') . '/template/extension/module/pavverticalmenu/widgets/'.$layout.'.tpl')) {
			$template = DIR_TEMPLATE.$this->config->get('theme_default_directory') . '/template/extension/module/pavverticalmenu/widgets/'.$layout.'.tpl';
		} else {
	...
	public function renderButton( $id ){
		...
		if( !empty($content) ){
			...
			$output = '<div class="pavo-widget" id="vpavowid-'.$id.'">';
				$output .= $content ;
			$output .= '</div>';
			return $output;	
		}
