	 ...
	 <div class="tab-content hightlight">
		<?php foreach( $tabs as $tab => $products ) {
			...
			?>
				...
				<a class="carousel-control left" href="#tab-<?php echo $tab.$id;?>"   data-slide="prev"><i class="zmdi zmdi-arrow-left zmdi-hc-fw"></i></a>
				<a class="carousel-control right" href="#tab-<?php echo $tab.$id;?>"  data-slide="next"><i class="zmdi zmdi-arrow-right zmdi-hc-fw"></i></a>
				</div>
				<?php } ?>
