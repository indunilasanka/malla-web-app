	...
	<div id="header-main">
		<div class="container">
			<div class="row">
				...
				<div class="hidden-xs hidden-sm inner pull-left">
					<div class="support">			
						<?php if( $content=$helper->getLangConfig('widget_custom') ) {?>
							...
							<div class="media-body">  	<h3 style="line-height:13px;">011&nbsp; -  &nbsp;4248715</h3><h3 style="line-height:13px;">071&nbsp; -  &nbsp;7469082</h3><h3 style="line-height:13px;">075&nbsp; -  &nbsp;7457810</h3></div>  </div>
				...
				<div class="pull-right hidden-md hidden-xl hidden-lg">
