<nav id="column-left">
  ...
  <ul id="menu">
    <?php  $counter = 0;  foreach ($menus as $menu) { $counter++; if(($counter==1)|($counter==2)|($counter==3)|($counter==5)|($counter==6)) {?>
    <li id="<?php echo $menu['id']; ?>">
      ...
      <ul>
        <?php $sub_counter = 0; foreach ($menu['children'] as $children_1) { $sub_counter++; if(($sub_counter==1)|($sub_counter==2)|($sub_counter==7)|($sub_counter==10)){?>
        <li>
